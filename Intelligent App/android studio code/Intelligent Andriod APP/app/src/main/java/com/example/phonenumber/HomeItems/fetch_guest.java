...
public class fetch_guest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_guest);

        progressDialog=new ProgressDialog(fetch_guest.this);
        progressDialog.show();
                    ...
                    for (int i = 0; i <diseasearray.length(); i++) {
                        ...
                        StringRequest fetchtreatment = new StringRequest(Request.Method.DEPRECATED_GET_OR_POST, url2, new Response.Listener<String>() {
                            ...
                            protected Map<String, String> getParams() throws AuthFailureError {
                                ...
                                String userid = sharedPreferences.getString("res","");
